...
## 🚩 Внимание: Лицензионное ограничение
Этот проект **не является свободным ПО**. 
Использование в организациях, копирование и перепродажа без согласия автора запрещены. 
